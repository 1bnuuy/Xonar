...
export default function ErrorPage() {
  return (
    <section className="flex h-dvh flex-col items-center justify-center gap-5 px-3 select-none">
      <div className="relative z-20">
        <span className="text-accent absolute top-2 left-1/2 -z-10 -translate-1/2 text-[calc(10em+3vw)] font-bold">
          404
        </span>
